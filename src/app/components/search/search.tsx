...
export default function Search({ recipes }: SearchProps) {
  ...
  return (
    <div className="search__wrapper w-full mb-2 md:mb-4 lg:mb-6">
      <div className="search__form flex flex-col w-full md:w-1/2 lg:w-1/4">
        <div className="relative flex flex-1 flex-shrink-0">
          ...
          <input
            className="peer block w-full rounded-s-md border-2 border-gray-200 py-[9px] pl-10 text-sm outline-2 placeholder:text-gray-500 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-s-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500 focus:z-9"
          ...
          />
          <MagnifyingGlassIcon className="absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900 z-10" focusable="false" />
          <button 
            id="reset-search"
            type="reset"
            className="-ml-0.5 inline-block rounded-e-md border-2 border-primary px-2 pb-[6px] pt-2 outline-2 hover:border-primary-600 hover:bg-neutral-500 hover:bg-opacity-10 hover:text-primary-600 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-s-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500 active:border-primary-700  focus:z-9"
            // onClick={(e) => {
      ...
      {searchInput && 
        <div className="search__results bg-neutral-100 rounded-lg p-4 md:p-6 w-full mt-4">
